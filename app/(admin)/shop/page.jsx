                ...
                <li class="relative" key={index}>
                  ...
                  <div class="relative flex justify-between items-center text-gray-500 hover:text-white focus-within:text-white">
                    <div class="flex items-center w-full">
                      ...
                      <span class="inline-block w-full py-2 pl-8 pr-4 text-xs rounded hover:bg-gray-800 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:bg-gray-800">
                        {menu.name}
                      </span>
                    </div>
                    <button
                  ...
                  <div class="pt-2 pl-4 hidden peer-checked:block transition-[display] duration-300">
